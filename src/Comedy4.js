        ...
        return <div className="AllMoviesContainer">
                  ...
                  <hr />
                    ...
                    <Link to='/Comedy'>< button ><h3>1</h3></button></Link>
                      ...
                      <Link to='/Comedy3'><button ><h3>3</h3></button></Link>
                      <Link to='/Comedy4'><button className='current'><h3>4</h3></button></Link>
                      <Link to='/Comedy5'><button ><h3>5</h3></button></Link>
                      <Link to='/ComedyEnd'><KeyboardDoubleArrowRightIcon/></Link>
                    </div>
                    <footer>
                      <div className="links">
                          <h5>tems</h5>
