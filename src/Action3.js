...
function Action3() {
  ...
  useEffect(
          ()=>{
            fetch('https://api.themoviedb.org/3/discover/movie?api_key=4ba0c9d319e748dedd11b904098470a7&with_genres=28&page=3')
            .then(res=>res.json())
  ...
  ,[])
        ...
        return <div className="AllMoviesContainer">
                  ...
                  <div className='Allmovies'>
                    {movieData.map(data=>{
                      return(
                              <div key={data.id} id={data.id} className="movieContainer">
                  ...
                  <hr />
                    ...
                    <Link to='/Action'>< button ><h3>1</h3></button></Link>
                      <Link to='/Action2'>< button ><h3>2</h3></button></Link>
                      <Link to='/Action3'><button className='current'><h3>3</h3></button></Link>
                      <Link to='/Action4'><button ><h3>4</h3></button></Link>
                      <Link to='/Action5'><button ><h3>5</h3></button></Link>
                      <Link to='/ActionEnd'><KeyboardDoubleArrowRightIcon/></Link>
                    </div>
                    <footer>
                      <div className="links">
                          <h5>tems</h5>
