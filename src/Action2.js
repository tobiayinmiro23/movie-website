...
function Action2() {
  ...
  useEffect(
          ()=>{
            fetch('https://api.themoviedb.org/3/discover/movie?api_key=4ba0c9d319e748dedd11b904098470a7&with_genres=28&page=2')
            .then(res=>res.json())
        ...
        return <div className="AllMoviesContainer">
                  ...
                  <hr />
                    ...
                    <Link to='/Action'>< button ><h3>1</h3></button></Link>
                      <Link to='/Action2'>< button className='current'><h3>2</h3></button></Link>
