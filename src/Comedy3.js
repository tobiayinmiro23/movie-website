  ...
  const ShowMovie=(param)=>{
    ...
    page('/Movie')
        ...
        return <div className="AllMoviesContainer">
                  <header>
                      <div onClick={()=>page('/Home')} className="img"><img src="/image/arrow.png" alt="" /></div>
                  ...
                  <hr />
                    ...
                    <button  onClick={()=>page('/Comedy')}><h3>1</h3></button>
                      ...
                      <button onClick={()=>page('/Comedy3')} className='current'><h3>3</h3></button>
