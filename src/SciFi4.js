        ...
        return <div className="AllMoviesContainer">
                  ...
                  <hr />
                    ...
                    <Link to='/Sci-fi'>< button ><h3>1</h3></button></Link>
                      ...
                      <Link to='/Sci-fi4'><button className='current'><h3>4</h3></button></Link>
                      <Link to='/Sci-fi5'><button ><h3>5</h3></button></Link>
                      <Link to='/Sci-fiEnd'><KeyboardDoubleArrowRightIcon/></Link>
                    </div>
                    <footer>
                      <div className="links">
                          <h5>tems</h5>
