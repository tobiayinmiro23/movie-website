...
function MostPopular() {
  ...
  useEffect(
          ()=>{
            fetch('https://api.themoviedb.org/3/movie/popular?api_key=4ba0c9d319e748dedd11b904098470a7&language=en-US&page=1&sort_by=popularity.desc')
            .then(res=>res.json())
            .then(data=>{
  ...
  ,[])
        return <div className="AllMoviesContainer">
                  <header>
                      <h1 className='heading'>MostPopular</h1>
                  </header>
                 {loading &&
                  <div className="anime">
                  ...
                  <hr />
                    {
                      movieData.length !==0  &&
                          <div>
                            ...
                            <Link to={`/MostPopular`}><button className='current' ><h3>1</h3></button></Link>
                            <Link to={`/MostPopular2`}><button  ><h3>2</h3></button></Link>
                            <Link to={`/MostPopular3`}><button  ><h3>3</h3></button></Link>
                            <Link to={`/MostPopular4`}><button  ><h3>4</h3></button></Link>
                            <Link to={`/MostPopular5`}><button  ><h3>5</h3></button></Link>
                            <Link to={`/MostPopularEnd`}><div ><KeyboardDoubleArrowRightIcon/></div></Link>
                            </div>
                            <Footer/>
                          </div>
