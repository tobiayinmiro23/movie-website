        ...
        return <div className="AllMoviesContainer">
                  ...
                  <hr />
                    ...
                    <Link to='/Anime'>< button ><h3>1</h3></button></Link>
                      <Link to='/Anime2'>< button ><h3>2</h3></button></Link>
                      <Link to='/Anime3'><button ><h3>3</h3></button></Link>
                      <Link to='/Anime4'><button className='current'><h3>4</h3></button></Link>
                      <Link to='/Anime5'><button ><h3>5</h3></button></Link>
                      <Link to='/AnimeEnd'><KeyboardDoubleArrowRightIcon/></Link>
                    </div>
                    <footer>
                      <div className="links">
                          <h5>tems</h5>
