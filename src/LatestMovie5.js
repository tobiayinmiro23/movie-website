        ...
        return <div className="AllMoviesContainer">
                  ...
                  <hr />
                    <div className="moviebtns">
                      ...
                      <button onClick={()=>page('/LatestMovie5')} className='current'><h3>5</h3></button>
                      <div onClick={()=>page('/LatestMovieEnd')}><KeyboardDoubleArrowRightIcon/></div>
                    </div>
                    <footer>
                      <div className="links">
                          <h5>tems</h5>
